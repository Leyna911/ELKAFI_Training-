      ...
      <div className='flex flex-col justify-center items-center'>
       ...
       <div  className='flex  flex-col sm:flex-row  mt-5  '>
        {cardInfosCours.map((info)=>
                  ...
                  <figure class="flex flex-col w-[450px] items-center justify-center p-3 mx-2 rounded text-center bg-white border-b  drop-shadow-xl  dark:bg-[#1c103f] hover:drop-shadow-2xl  hover:brightness-200 transition-all duration-300 ease-in-out ">
